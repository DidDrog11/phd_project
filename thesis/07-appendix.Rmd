...
``` {r ppc, fig.scap = "Posterior predictive checks", fig.cap = '(ref:long-c24)'}

knitr::include_graphics(here("thesis", "appendices_files", "C2-4.png"))

```

(ref:long-c24) Posterior predictive checks of the final Bayesian multi-species occupancy model. The fit statistic for the observed data and fitted model is shown. Pink points represent a positive discrepancy in the fit statistic with blue points representing a negative discrepancy in the fit statistic. Fit statistics clustered around the black line (representing no discrepancy) indicate better model validation to data.
...
### Random-effects meta-analysis 15m contacts

```{r s-1a, fig.scap = '(ref:short-s1a)', fig.cap = '(ref:long-s1a)'}

knitr::include_graphics(here("thesis", "appendices_files", "C5-1.png"))

```

(ref:short-s1a) Random effects meta-analysis of ERGMs (15m) estimating the odds of a contact being observed for *M natalensis*.

(ref:long-s1a) Random effects meta-analysis of ERGMs (15m) estimating the odds of a contact being observed for *M natalensis*. Points represent the weighted estimate of the pooled effect size, whiskers encompass the 95% Confidence Interval. A) The odds ratio of a contact being observed for *M. natalensis* in Agricultural or Village land use types. B) The odds ratio of a contact being observed between *M. natalensis* and an individual of a different species. C) The odds ratio of a contact being observed between *M. natalensis* and another *M. natalensis*.

### Random-effects meta-analysis 50m contacts

```{r s-1b, fig.scap = '(ref:short-s1b)', fig.cap = '(ref:long-s1b)'}

knitr::include_graphics(here("thesis", "appendices_files", "C5-2.png"))

```

(ref:short-s1b) Random effects meta-analysis of ERGMs (50m) estimating the odds of a contact being observed for *M natalensis*.

(ref:long-s1b) Random effects meta-analysis of ERGMs (50m) estimating the odds of a contact being observed for *M natalensis*. Points represent the weighted estimate of the pooled effect size, whiskers encompass the 95% Confidence Interval. A) The odds ratio of a contact being observed for *M. natalensis* in Agricultural or Village land use types. B) The odds ratio of a contact being observed between *M. natalensis* and an individual of a different species. C) The odds ratio of a contact being observed between *M. natalensis* and another *M. natalensis*.
